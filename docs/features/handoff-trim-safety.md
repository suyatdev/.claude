...
Status: planning. Compliance round 1 FAILED with 9 violations, all addressed in the revision;
round 2 pending. The gate has not opened.
...
| Zero-match glob warning removed | the memsearch glob scenario |
